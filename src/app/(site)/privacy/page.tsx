      ...
      <section className="pt-3 pb-25">
        <div className="max-w-[1170px] text-[black]/70 dark:text-[white]/50 mx-auto px-4 sm:px-8 xl:px-0 z-10 pt-25">
          ...
          <div className="mt-8">
            ...
            <p className="mt-4">The {siteConfig.siteName} Website and any Software or Services available on that site are not directed at children under 16 years or other permitted by the applicable law age. However, we recognize that children under the permitted age may access this Website and subscribe to the newsletter, purchase Software and Services, or download software programs. The collection of information is covered above. Parents and Legal Guardians may request from us to review, delete or stop the collection of the personally identifiable information of their child. You may do so by contacting LeandMe by letter or email to {siteConfig.adminEmail}.</p>
