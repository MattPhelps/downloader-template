...
const data = [
    ...
    {
        question: "2. Is YT Saver secure?",
        answer: "Yes, YT Saver is 100% safe to use. No malware or trojans will be added when you download this software to your computer, and your personal information will remain confidential."
    },
    {
        question: "3. What is the difference between the free and the paid version?",
        answer: "Although the free trial version is limited, we always recommend our new users to try the free version first before buying YT Saver. The trial version only provides you 3 downloads, 1 playlist, limited output formats, while the paid version doesn't have any limitations."
    },
    {
