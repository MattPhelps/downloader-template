...
const Render = () => {
    ...
    <div className='flex flex-col gap-[5px] lg:gap-[20px] w-full h-full'>
        <div className='w-full flex flex-col gap-[5px]'>
            ...
            <p className='text-center justify-center text-[11px] justify-center gap-[3px] flex items-center'>
                Low resolution<ToolBox text={"Low resolution and a bit tedious - but it's free"} />
            </p>
        </div>
        <div className='w-full flex flex-col gap-[5px]'>
            <button title="This is a tooltip message"
                className="
                justify-center
                inline-flex
                rounded-lg
...
const ToolBox = ({ text }) => {
    return (
        <span className="tooltip bg-[gray] w-[12px] h-[12px] flex items-center justify-center text-[10px] rounded-full text-[white]">
